...
const char *const HTTP_PORTAL_MENU[] PROGMEM = {
    "<form action='/wifi'    method='get'><button>Ayarlar</button></form><br/>\n",              // MENU_WIFI
    "<form action='/0wifi'   method='get'><button>Ayarlar (Gelişmiş)</button></form><br/>\n",   // MENU_WIFINOSCAN
    "<form action='/info'    method='get'><button>Bilgi</button></form><br/>\n",                // MENU_INFO
    "<form action='/param'   method='get'><button>Setup</button></form><br/>\n",                // MENU_PARAM
    "<form action='/close'   method='get'><button>Çıkış</button></form><br/>\n",                // MENU_CLOSE
    "<form action='/restart' method='get'><button>Restart</button></form><br/>\n",              // MENU_RESTART
    "<form action='/exit'    method='get'><button>Çıkış</button></form><br/>\n",                // MENU_EXIT
    "<form action='/erase'   method='get'><button class='D'>Sil</button></form><br/>\n",        // MENU_ERASE
    "<form action='/update'  method='get'><button>Yazılım Güncellemesi</button></form><br/>\n", // MENU_UPDATE
    "<hr><br/>"                                                                                 // MENU_SEP
};
...
const char HTTP_SAVED[] PROGMEM = "<div class='msg'>Seçilen Ağ Kaydedildi.<br/>WiFi Ağına Bağlanmaya Çalışıyor.<br />Eğer Bu Sayfa 30 sn. İçerisinde Kapanmazsa WiFi Adı Veya Şifresi Hatalıdır.</div>";
const char HTTP_PARAMSAVED[] PROGMEM = "<div class='msg S'>Kaydedildi.<br/></div>";
const char HTTP_END[] PROGMEM = "</div></body></html>";
const char HTTP_ERASEBTN[] PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>Wifi Verilerini Sil</button></form>";
const char HTTP_UPDATEBTN[] PROGMEM = "<br/><form action='/update' method='get'><button>Güncelle</button></form>";
const char HTTP_BACKBTN[] PROGMEM = "<hr><br/><form action='/' method='get'><button>Geri Çık</button></form>";

const char HTTP_STATUS_ON[] PROGMEM = "<div class='msg S'><strong>Connected</strong> to {v}<br/><em><small>with IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[] PROGMEM = "<div class='msg {c}'><strong>Bağlantı Yok/strong> to {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
...
const char HTTP_STATUS_NONE[] PROGMEM = "<div class='msg'>WiFi Ayarlı Değil!</div>";
...
const char HTTP_HELP[] PROGMEM =
    "<br/><h3>İletişim: 0552 207 2057</h3><hr>";
#else
const char HTTP_HELP[] PROGMEM = "";
#endif

const char HTTP_UPDATE[] PROGMEM = "Yeni Yazılım Yükleme<br/><form method='POST' action='u' enctype='multipart/form-data' onchange=\"(function(el){document.getElementById('uploadbin').style.display = el.value=='' ? 'none' : 'initial';})(this)\"><input type='file' name='update' accept='.bin,application/octet-stream'><button id='uploadbin' type='submit' class='h D'>Güncelle</button></form><small><a href='http://192.168.4.1/update' target='_blank'></a><small>";
const char HTTP_UPDATE_FAIL[] PROGMEM = "<div class='msg D'><strong>Günzelleme Hatası!</strong><Br/>Reboot device and try again</div>";
const char HTTP_UPDATE_SUCCESS[] PROGMEM = "<div class='msg S'><strong>Başarılı Şekilde Güncellendi.  </strong> <br/> Cihaz Yeniden Başlatılıyor...</div>";
...
#else
const char HTTP_INFO_esphead[] PROGMEM = "<h3>Ayrıntılar</h3><hr><dl>";
const char HTTP_INFO_fchipid[] PROGMEM = "<dt>Çip Numarası</dt><dd>{1}</dd>";
const char HTTP_INFO_corever[] PROGMEM = "";
const char HTTP_INFO_bootver[] PROGMEM = "";
const char HTTP_INFO_lastreset[] PROGMEM = "";
const char HTTP_INFO_flashsize[] PROGMEM = "<dt>Yazılım Boyutu</dt><dd>{1} bytes</dd>";
#endif
...
const char HTTP_INFO_stamac[] PROGMEM = "<dt>Wifi MAC Adresi</dt><dd>{1}</dd>";
...
const char HTTP_INFO_aboutdate[] PROGMEM = "<dt>Kurulum Tarihi</dt><dd>{1}</dd>";
...
const char S_titlewifi[] PROGMEM = "Cihazı Yapılandır";
const char S_titleinfo[] PROGMEM = "Bilgi";
const char S_titleparam[] PROGMEM = "Ayar";
...
const char S_titleclose[] PROGMEM = "Çıkış";
...
const char S_exiting[] PROGMEM = "Çıkış";
const char S_resetting[] PROGMEM = "Cihaz Birkaç Saniye İçinde Sıfırlanacak.";
const char S_closing[] PROGMEM = "Sayfayı kapatabilirsiniz, portal çalışmaya devam edecektir.";
